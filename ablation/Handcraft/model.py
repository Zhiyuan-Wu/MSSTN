...
class ReiWa(object):
    ...
    def default_model(self,args):
        ...
        self.spatial_feature_0 = tf.placeholder(tf.float32, shape=(args['num_nodes_0'], args['seq_len'], args['spatial_feature_dim_0']), name='input_0')
        self.pred_0, self.loss_0, self.loss_mse_0 = self.DCN(tf.concat([self.input_0,self.spatial_feature_0],axis=2), 'DCN_0', args)
