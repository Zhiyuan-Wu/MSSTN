...
class dataset(object):
    def __init__(self,args):
        ...
        self.tr = []
        self.te = []
        self.spatial_img_0 = np.load(args['spatial_img_path_0'])
        self.tr_spatial_img_0 = self.spatial_img_0[:81*90+1]
        self.te_spatial_img_0 = self.spatial_img_0[81*90+1:81*117+2]
    ...
    def tr_get_batch(self,id=None):
        ...
        batch_set = []
        batch_spatial_img = self.tr_spatial_img_0[idx_start:idx_end+1]
        for i in range(len(self.tr)):
            batch_set.append(self.tr[i][:,idx_start:idx_end+1])
        
        return batch_mid,batch_set,batch_spatial_img
    ...
    def te_get_batch(self,id=None):
        ...
        batch_set = []
        batch_spatial_img = self.te_spatial_img_0[idx_start:idx_end+1]
